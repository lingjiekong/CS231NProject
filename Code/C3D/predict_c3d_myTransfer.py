...
def run_test():
  ...
  # model_name = "models/my_c3d_model-99"
  ...
  for gpu_index in range(0, gpu_num):
    with tf.device('/gpu:%d' % gpu_index):
      myWeights = _variable_with_weight_decay('wout', [4096, c3d_model_transfer.NUM_CLASSES], 0.04, 0.005)
      myBiases = _variable_with_weight_decay('bout', [c3d_model_transfer.NUM_CLASSES], 0.04, 0.0)
  ...
  for step in xrange(all_steps):
    ...
    print('True: {}'.format(test_labels))
    print('Predict: {}'.format(top1_predicted_label))
    ...
    for i in range(0, valid_len):
      ...
      write_file.write('{}, {}, {}, {}\n'.format(
              true_label,
              predict_score[0, i, true_label],
              top1_predicted_label[i],
              predict_score[0, i, top1_predicted_label[i]]))
  write_file.close()
  print("done")
